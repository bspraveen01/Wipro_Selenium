...
import org.openqa.selenium.Alert;
public class IgnoringTestMethods {
	WebDriver driver;
...
public void RegisterPage() throws InterruptedException {
	WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
       ...
       wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("FirstName"))).sendKeys("Sriram");
       driver.findElement(By.id("LastName")).sendKeys("Praveen");
       driver.findElement(By.id("Email")).sendKeys("Srirampraveenb@gmail.com"); // unique email
       driver.findElement(By.id("Password")).sendKeys("Sriam@123");
       driver.findElement(By.id("ConfirmPassword")).sendKeys("Sriram@123");
...
public void LoginPage() throws InterruptedException {
	...
	// Wait for email field
		//wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("Email"))).sendKeys("srirampraveen123");
	driver.findElement(By.id("Email")).sendKeys("srirampraveenb@gmail.com");
	driver.findElement(By.id("Password")).sendKeys("Sriram@123");
